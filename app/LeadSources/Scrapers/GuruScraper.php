...
class GuruScraper implements ScraperInterface
{
    ...
    public function scrape(LeadSource $source): int
    {
        ...
        $url = 'https://www.guru.com/dyn/jobs/rss?q=' . urlencode($query);
        ...
        if (! $response->successful()) {
            activity()->log($source, 'lead_source.scrape_error', "Guru RSS returned HTTP {$response->status()}.");
