                        ...
                        <dl class="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <dd class="mt-1 text-sm text-gray-900">
                                    <a v-if="client.website" :href="client.website" target="_blank" class="text-indigo-600 hover:text-indigo-900">{{ client.website }}</a>
                                    <span v-else>-</span>
                                </dd>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <dd class="mt-1 text-sm text-gray-900">{{ client.last_contacted_at ?? '-' }}</dd>
                            </div>
                            <div>
