                ...
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                    <form class="p-6" @submit.prevent="submit">
                        <div class="mb-6">
                            ...
                            <TextInput id="key" v-model="form.key" type="text" class="mt-1 block w-full" placeholder="e.g. welcome_email" />
                            <InputError :message="form.errors.key" class="mt-2" />
                        </div>

                        <div class="mb-6">
                            <InputLabel for="name" value="Name" />
                            <TextInput id="name" v-model="form.name" type="text" class="mt-1 block w-full" placeholder="e.g. Welcome Email" />
                            <InputError :message="form.errors.name" class="mt-2" />
                        </div>

                        <div class="mb-6">
                            <InputLabel for="subject" value="Subject" />
                            <TextInput id="subject" v-model="form.subject" type="text" class="mt-1 block w-full" placeholder="Use {{variable}} for placeholders" />
